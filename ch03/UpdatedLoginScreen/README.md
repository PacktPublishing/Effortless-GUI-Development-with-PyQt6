# UpdatedLoginScreen project

## Information

This folder contains the code for the **Updated LoginScreen Project** example from Chapter 03 
...
You may also open the `UpdatedLoginScreen.pyproject` in QtCreator and run it there.
