...
This folder contains the code for the **NumericInput Project** example from Chapter 03 
...
You may also open the `NumericInput.pyproject` in QtCreator and run it there.
