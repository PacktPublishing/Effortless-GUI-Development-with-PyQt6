...
This folder contains the code for the **Advanced Dashboard Project** example from Chapter 04
...
You may also open the `dashboardConnected.pyproject` in QtCreator and run it there.
