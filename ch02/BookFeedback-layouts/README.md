# BookFeedback-layouts project

## Information

This folder contains the code for the **BookFeedback-layouts Project** example from Chapter 02
...
You may also open the `BookFeedback-layouts.pyproject` in QtCreator and run it there.
