# BookFeedback project


## Information

This folder contains the code for the **BookFeedback Project** example from Chapter 02 
...
You may also open the `BookFeedback.pyproject` in QtCreator and run it there.
